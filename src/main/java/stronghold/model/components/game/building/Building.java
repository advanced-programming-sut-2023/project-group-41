...
public abstract class Building {
    ...
    protected ArrayList<Resources> neededResources;
    ...
    public Building(int health, int cost, int workerNum, boolean engineerWorkers,
                    ArrayList<Resources> neededResources, int populationEffect, int popularityEffect) {
        this.health = health;
        this.cost = cost;
    ...
    public ArrayList<Resources> getNeededResources() {
